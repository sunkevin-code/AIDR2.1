...
function normalizeOccurrence(event = {}, atom = {}, mapping = {}, boundary = {}) {
  ...
  return {
    ...
    endpointId: event.endpointId || detail.endpointId || null,
    ...
    processId: event.processId || event.pid || detail.processId || detail.process_id || detail.pid || null,
    parentProcessId: event.parentProcessId || event.ppid || detail.parentProcessId || detail.parent_process_id || detail.ppid || null,
    toolCallId: event.toolCallId || detail.toolCallId || detail.tool_call_id || detail.callId || null,
    resourceId: event.resourceId || detail.resourceId || detail.resource_id || detail.path || detail.url || detail.target || null,
    ...
    atom: {
      ...
      mappingVersion: mapping.mappingVersion || "rules-v4-identity-structured",
      ...
      explanation: mapping.explanation || event.mappingExplanation || null
    },
